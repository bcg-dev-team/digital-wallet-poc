...
export interface MemberLoginHistoryResponse {
  /** 로그인 일시 */
  loginTime: string;
  /** 로그인 상태 */
  loginState: boolean;
...
export interface PageResponseMemberLoginHistoryResponse {
  /** */
  contents: Array<MemberLoginHistoryResponse>;
  /** 총 페이지 갯수 */
  totalPages?: number;
  /** 총 데이터 건수 */
...
export interface ResponseDataPageResponseMemberLoginHistoryResponse
  extends ApiSuccessResponse<PageResponseMemberLoginHistoryResponse> {}
