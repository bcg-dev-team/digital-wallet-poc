...
- 경로: `/screens`
- 컴포넌트: `ScreenIndex`
- 파일: `apps/mobile/src/components/ScreenIndex.tsx`
- 비고: 주요 화면으로 이동할 수 있는 내부 인덱스
...
| 입금 02. MetaMask 연결 완료 | `/deposit/wallet-connected` | `DepositWalletConnected` | `apps/mobile/src/components/DepositWalletConnected.tsx` |
| 입금 03. 금액 입력 | `/deposit/amount` | `DepositAmountEntry` | `apps/mobile/src/components/DepositAmountEntry.tsx` |
| 입금 04. 입금 진행 중 | `/deposit/processing` | `DepositProcessing` | `apps/mobile/src/components/DepositProcessing.tsx` |
| 입금 05. 입금 완료 | `/deposit/completion` | `DepositCompletion` | `apps/mobile/src/components/DepositCompletion.tsx` |
