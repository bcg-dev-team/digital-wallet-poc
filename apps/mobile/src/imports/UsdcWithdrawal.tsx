...
import WithdrawalCompleteBottomSheet from "../components/WithdrawalCompleteBottomSheet";
...
function Frame11({ onNavigateBack }: { onNavigateBack?: () => void }) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
...
function Frame30({ onNavigateBack }: { onNavigateBack?: () => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
      <Frame11 onNavigateBack={onNavigateBack} />
...
function Frame41({ onNavigateBack }: { onNavigateBack?: () => void }) {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-0 w-[360px] pb-[120px]">
      <Frame30 onNavigateBack={onNavigateBack} />
      <Frame31 />
    </div>
  );
}

// 버튼 부분을 @digital-wallet/ui로 교체
function BottomButtons({ onWithdrawal, onCancel }: { onWithdrawal: () => void; onCancel?: () => void }) {
  return (
    <MobileStickyFooter className="z-50">
...
export default function UsdcWithdrawal({ onNavigateBack, onNavigateToHistory }: UsdcWithdrawalProps) {
  ...
  return (
    <div className="bg-white relative flex size-full min-h-full flex-col" data-name="12.출금">
      <Frame41 onNavigateBack={onNavigateBack} />
      <BottomButtons
