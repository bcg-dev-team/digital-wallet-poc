...
function Frame2117921400() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-center w-full">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] leading-[28px] relative shrink-0 text-[#111111] text-[20px] tracking-[-0.1px] w-full font-bold">환전을 처리하고 있어요</p>
      <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#999ea4] text-[14px] w-full">블록체인에서 트랜잭션을 확인하고 있어요</p>
    </div>
  );
}
...
function Frame2117921396() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col items-start ml-[30px] mt-0 not-italic relative w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#333950] text-[14px] w-full font-bold">환전 신청 완료</p>
...
function Process() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="process">
      ...
      <div className="[grid-area:1_/_1] ml-px mt-[282px] relative size-[20px]" data-name="ic_00com_20_sld_number_3">
        <div className="absolute inset-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <circle cx="10" cy="10" fill="var(--fill-0, #CCCFD3)" id="Ellipse 912" r="10" />
          </svg>
      ...
      <div className="[grid-area:1_/_1] flex h-[48px] items-center justify-center ml-[10px] mt-[234px] relative w-px">
        <div className="flex-none rotate-[180deg]">
          <div className="bg-[#dddddd] h-[48px] w-px" data-name="line" />
        </div>
      </div>
      ...
      <div className="[grid-area:1_/_1] ml-0 mt-[146px] relative size-[20px]" data-name="ic_00com_20_sld_check_circle">
        <div className="absolute inset-0" data-name="btn_check_r_o">
          <Group81 />
          <Group823354 />
        </div>
...
function Frame2117921398() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[54px] not-italic top-[170px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#333950] text-[14px] w-full font-bold">컴플라이언스 검증 중</p>
      <p className="basis-0 font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] grow leading-[18px] min-h-px min-w-px relative shrink-0 text-[#2a3fec] text-[12px] w-full">예상 시간: 1-3분</p>
    </div>
  );
}
...
function Frame2117921397() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[54px] not-italic top-[102px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#333950] text-[14px] w-full font-bold">USDC 입고 확인</p>
      <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[18px] relative shrink-0 text-[#999ea4] text-[12px] w-full">블록체인 트랜잭션 검증 완료</p>
    </div>
  );
}

function Frame2117921399() {
  return <div className="absolute h-[42px] left-[54px] top-[238px] w-[143px]" />;
}

function Frame2117921409() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[54px] not-italic top-[303px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#aaaeb3] text-[14px] w-full font-bold">계좌 반영</p>
...
function Frame2117921410() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42px] items-start left-[54px] not-italic top-[238px] w-[143px]">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#aaaeb3] text-[14px] w-full font-bold">예금토큰 발행</p>
      <p className="basis-0 font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] grow leading-[18px] min-h-px min-w-px relative shrink-0 text-[#999ea4] text-[12px] w-full">대기중</p>
    </div>
  );
}
...
function Contents() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[50px] items-center left-[20px] top-[80px] w-[320px] pb-[112px]" data-name="+ CONTENTS">
      <Frame2117921401 />
      <Frame2117921403 />
    </div>
  );
...
export default function Component09({ onNavigateHome, onNavigateBack }: { onNavigateHome?: () => void; onNavigateBack?: () => void }) {
  return (
