...
function TrListModule({ onSelect }: { onSelect?: () => void }) {
...
function Component16({ onSelectFirst }: { onSelectFirst?: () => void }) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="실시간순위_거래대금">
      <TrListModule onSelect={onSelectFirst} />
      <div className="bg-white box-border content-stretch flex flex-col gap-[8px] h-[68px] items-start justify-center max-w-[320px] overflow-clip px-0 py-[12px] relative shrink-0 w-full" data-name="tr_list_module">
        <ListContents1 />
      </div>
    </div>
...
interface TokenSecuritiesScreenProps {
  onSelectFirst?: () => void;
}
